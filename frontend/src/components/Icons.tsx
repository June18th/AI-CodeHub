export function LogoIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      <path d="M16 6l.9 3.5c.5 1.8 1.7 3.2 3.5 3.7L24 14l-3.6.8c-1.8.5-3.2 1.8-3.6 3.5L16 22l-.8-3.7c-.4-1.7-1.8-3-3.6-3.5L8 14l3.6-.8c1.8-.5 3.2-1.9 3.6-3.7L16 6z"
        fill="white" opacity=".95" />
      <circle cx="10" cy="10" r="1.2" fill="white" opacity=".4" />
      <circle cx="23" cy="12" r="1" fill="white" opacity=".3" />
      <circle cx="9" cy="21" r="1" fill="white" opacity=".25" />
    </svg>
  );
}
